...
layout: single
sitemap: false
permalink: /pages/Econ_390_SP26_L21/
...
[Download Jupyter Notebook Completed](https://m-mcmain.github.io/files/Econ390SP26/Lectures/Lecture21_OLS_full.ipynb)
...
```
    ...
    <matplotlib.collections.PathCollection at 0x1d8a705e510>
...
ax.set(xlabel="Total Fare (Dollars)", ylabel="Total Tip (% of Fare)")
sns.despine()
plt.show()
```
    ...
    ----> 3 ax.set(xlabel="Total Fare (Dollars)", ylabel="Total Tip (% of Fare)")
          4 sns.despine()
          5 plt.show()
...
# Use .set on ax_joint
ax = sns.jointplot(x="fare", y="tip_pct",data=taxi);
ax.ax_joint.set(xlabel="Total Fare (Dollars)", ylabel="Total Tip (% of Fare)")
sns.despine()
plt.show()
```
...
ax.ax_joint.set(xlabel="Payment Type", ylabel="Total Tip (% of Fare)")
sns.despine()
plt.show()
...
```
    ...
    <statsmodels.regression.linear_model.RegressionResultsWrapper at 0x1d8b0ff0050>
...
```
    ...
    Date:                Tue, 14 Apr 2026   Prob (F-statistic):          1.07e-124
    Time:                        15:09:29   Log-Likelihood:                -17698.
...
```
    ...
    Date:                Tue, 14 Apr 2026   Prob (F-statistic):           1.84e-82
    Time:                        15:14:41   Log-Likelihood:                -17698.
    No. Observations:                4621   AIC:                         3.540e+04
    Df Residuals:                    4619   BIC:                         3.541e+04
    Df Model:                           1                                         
    Covariance Type:                  HC1                                         
...
```
    ...
    C:\Users\micha\AppData\Local\Temp\ipykernel_17532\1136982121.py:2: SettingWithCopyWarning: 
...
```
    ...
    <seaborn.axisgrid.FacetGrid at 0x1d8b0ff06e0>
...
```
    ...
    Date:                Tue, 14 Apr 2026   Prob (F-statistic):           1.47e-86
    Time:                        15:27:29   Log-Likelihood:                -17690.
...
```python
# Prettier printing
print(summary_col([reg_results, reg_results2]))
```
...
```python
# Options
print(summary_col([reg_results, reg_results2], stars=True, float_format="%0.2f",
                  regressor_order=["Intercept", "passengers", "fare"],
                  model_names=["(1)","(2)"]))
```
